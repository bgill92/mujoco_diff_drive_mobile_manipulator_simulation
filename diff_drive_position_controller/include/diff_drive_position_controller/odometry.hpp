...
// Copied from ros2_controllers diff_drive_controller (Jazzy) with the Humble
// compatibility shims removed and the namespace renamed.
/*
...
#ifndef DIFF_DRIVE_POSITION_CONTROLLER__ODOMETRY_HPP_
#define DIFF_DRIVE_POSITION_CONTROLLER__ODOMETRY_HPP_
...
public:
  ...
  [[nodiscard]] double getLinear() const { return linear_; }
...
#endif  // DIFF_DRIVE_POSITION_CONTROLLER__ODOMETRY_HPP_
